         ...
         justify-center bg-black/70'>
            <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
                ...
                <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                    ...
                    top-4 right-4 h-4 w-4 cursor-pointer' />
                    ...
                    <div className='w-full mt-4'>
                        ...
                        <input type="text" id="name" className='w-full mt-1 px-3 py-2.5 rounded-md
                    ...
                    <div className='w-full mt-4'>
                        ...
                        <input type="text" id="contact" className='w-full mt-1 px-3 py-2.5 rounded-md
                        border border-gray-200 outline-indigo-500 font-light' placeholder=
                    ...
                    <div className='w-full mt-4'>
                        ...
                        <input type="text" id="address" className='w-full mt-1 px-3 py-2.5 rounded-md
                    ...
                    <div className='w-full mt-4 max-w-60 mr-auto'>
                        ...
                        <select id="city" className='className="border border-gray-200 rounded
