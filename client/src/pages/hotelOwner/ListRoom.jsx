...
const ListRoom = () => {
    ...
    const toggleAvailability = async (roomId) => {
        const{data} = await axios.post(`/api/rooms/toggleAvailability`,{roomId},
    ...
    return (
        <div>
            <Title  align='left' font='outfit' title="Room Listings" subTitle="View,edit, or
